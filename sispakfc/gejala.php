...
<div class="panel panel-default">
    <div class="panel-heading">
        <form class="form-inline">
            ...
            <div class="form-group">
                <button class="btn btn-warning"><span class="glyphicon glyphicon-refresh"></span> Refresh</a>
            </div>
            <div class="form-group">
                <a class="btn btn-success" href="?m=gejala_tambah"><span class="glyphicon glyphicon-plus"></span> Tambah</a>
            </div>
        </form>
    </div>
